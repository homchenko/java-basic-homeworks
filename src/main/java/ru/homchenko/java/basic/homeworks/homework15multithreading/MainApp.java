...
public class MainApp {
    public static void main(String[] args) {
        ...
        Thread t1 = new Thread(() -> fillArr(0, 25_000_000, array2));
        Thread t2 = new Thread(() -> fillArr(25_000_000, 50_000_000, array2));
        Thread t3 = new Thread(() -> fillArr(50_000_000, 75_000_000, array2));
        Thread t4 = new Thread(() -> fillArr(75_000_000, 100_000_000, array2));
        t1.start();
        t2.start();
        t3.start();
        t4.start();
